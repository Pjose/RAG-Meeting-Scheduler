    ...
    <PublicLayout>
      ...
      <div className="bg-sidebar border-b border-sidebar-border">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
          ...
          <p className="text-sidebar-foreground/70 text-base max-w-lg mb-4">
            Find an AA meeting that fits your schedule. All meetings are open unless marked Closed.
          </p>
          <a
            href="https://rossavenuegroup.org"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 text-sm text-sidebar-foreground/80 hover:text-sidebar-foreground border border-sidebar-foreground/20 hover:border-sidebar-foreground/40 bg-sidebar-foreground/5 hover:bg-sidebar-foreground/10 transition-colors px-3 py-1.5 rounded"
          >
            <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
            rossavenuegroup.org
          </a>
        </div>
      </div>
