...
import { useGetHiSchedule } from "@workspace/api-client-react";
...
export default function PrintHiSchedule() {
  const scheduleQuery = useGetHiSchedule();
      ...
      {scheduleQuery.isLoading ? (
        ...
        <div ref={printRef} className="overflow-x-auto">
          ...
          {scheduleQuery.data?.days?.length === 0 && (
            <p className="text-center py-12 text-muted-foreground">No H&I meetings scheduled.</p>
          )}
        </div>
      )}
